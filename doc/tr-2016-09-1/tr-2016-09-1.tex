...
\item We want to add the possibility of a branch to be notified that it will be \emph{deactivated}. To do that, the switching of the branches must have a ``lag'' of a definable duration. This could go into a second starter element such as \Verb!IfLag!.
