...
//
//  def apply[S <: Sys[S], BU, LU, T <: TreeLike[S, BU, LU, T]](tree: T, config: TreeTableView.Config[S, T])
//                                                             (implicit tx: S#Tx,
//                                                              cursor: Cursor[S]): TreeTableView[S, T] = {
//
...
//  }
//
//  private abstract class Impl[S <: Sys[S], BU, LU, T <: TreeLike[S, BU, LU, T]]
